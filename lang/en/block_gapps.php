...
$string['autoaddsetting'] = 'Automatically add users';
$string['autoaddsettingdesc'] = 'This setting will automatically add users to the Google User Sync and create their account in Google on login.  For this to work, <em>Enable events</em> setting must be turned on and <em>Google SAML Auth</em> plugin must be configured and enabled.';
