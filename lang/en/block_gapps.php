...
$string['compose'] = 'Compose email';
$string['domainnotconfigured'] = 'The Google Apps domain is not configured in the Google Apps admin settings.';
...
$string['gmail'] = 'Gmail';
$string['msgnumberunread'] = 'Number of unread messages';
$string['msgnumberunreadinfo'] = 'The number of unread Gmail messages to display in the Google Apps block.';
...
$string['showlastnameinfo'] = 'Show the Gmail author\'s last name next to their message.';
$string['unreadmessages'] = 'You have {$a} unread messages in your inbox.';
$string['privacy:metadata:tool_googleadmin_users'] = 'Stores User\'s credentials for Google Apps';
$string['privacy:metadata:tool_googleadmin_users:userid'] = 'The User\'s ID';
$string['privacy:metadata:tool_googleadmin_users:email'] = 'The User\'s E-mail';
$string['privacy:metadata:tool_googleadmin_users:password'] = 'The User\'s Password';
$string['privacy:metadata:google_apps'] = 'In order to sync with Google Apps, user data needs to be exchanged with that service.';
$string['privacy:metadata:google_apps:userid'] = 'The Moodle user ID is being synced to Google Apps';
