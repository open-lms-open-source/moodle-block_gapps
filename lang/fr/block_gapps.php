...
$string['authorizeaccess'] = 'Autorisez l\'accès à Gmail pour afficher vos messages non lus ici.';
$string['calendar'] = 'Calendrier';
$string['clientid'] = 'ID client';
$string['clientiddesc'] = 'Il s\'agit de l\'ID client de votre compte de service dans la console développeur de Google. Cet ID n\'est requis que si vous souhaitez afficher les messages Gmail dans le bloc Google Apps.';
...
$string['gmail'] = 'Gmail';
$string['msgnumberunread'] = 'Nombre de messages non lus';
$string['msgnumberunreadinfo'] = 'Nombre de messages Gmail non lus à afficher dans le bloc Google Apps.';
$string['newwinlink'] = 'Ouvrir les liens dans une fenêtre contextuelle';
$string['newwinlinkinfo'] = 'Tous les liens inclus dans le bloc Google Apps s\'ouvrent dans une nouvelle fenêtre si ce réglage est activé.';
$string['nosubject'] = 'Aucun sujet';
$string['pluginname'] = 'Google Apps';
$string['showfirstname'] = 'Afficher le prénom';
