...
$options = array(0 => get_string('donothing', 'block_gdata'),   // do nothing
                 1 => get_string('disableacc', 'block_gdata'),  // disable
                 2 => get_string('deleteacc', 'block_gdata'));  // delete
$configs[] = new admin_setting_configselect('handlegusersync', get_string('hdlgusersync', 'block_gdata'),
                   get_string('hdlgusersyncdesc', 'block_gdata'),0, $options);
               
// Should admins be kept from syncing?
$configs[] = new admin_setting_configcheckbox('nosyncadmins', get_string('nosyncadminssetting', 'block_gdata'), get_string('nosyncadminssettingdesc', 'block_gdata'), 0);

// Remove admins from sync table right away
global $CFG,$FULLME;
$headaction = '<a href="'.$CFG->wwwroot.'/blocks/gdata/index.php?hook=cleanadmins&return='.$FULLME.'">'.get_string('cleanadminsfromsyncstr','block_gdata').'</a>';
$configs[] = new admin_setting_heading('cleanadminsfromsync',$headaction, $clearadminsfromsync);
