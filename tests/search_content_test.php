...
class search_content_testcase extends \advanced_testcase {
     ...
     * @return \block_gapps Block instance object
     */
    protected function create_block($course) {
        $page = self::construct_page($course);
        $page->blocks->add_block_at_end_of_default_region('gapps');
    ...
    public function test_search_area() {
        ...
        // Do indexing query.
        $area = new \block_gapps\search\content();
        $this->assertEquals('gapps', $area->get_block_name());
